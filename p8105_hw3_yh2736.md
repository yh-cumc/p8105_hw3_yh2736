...
##transfer response from chr to factor
brfss_dataset$response =  as.factor(brfss_dataset$response)
...
```
    ...
    ##  Factor w/ 5 levels "Excellent","Fair",..: 1 5 3 2 4 1 5 3 2 4 ...
...
```
    ...
    ##     year locationabbr locationdesc class topic question response
    ##    <int> <chr>        <chr>        <chr> <chr> <chr>    <fct>   
    ##  1  2002 WI           WI - Milwau~ Heal~ Over~ How is ~ Excelle~
    ##  2  2002 WI           WI - Milwau~ Heal~ Over~ How is ~ Very go~
    ##  3  2002 WI           WI - Milwau~ Heal~ Over~ How is ~ Good    
    ##  4  2002 WI           WI - Milwau~ Heal~ Over~ How is ~ Fair    
    ##  5  2002 WI           WI - Milwau~ Heal~ Over~ How is ~ Poor    
    ##  6  2002 WY           WY - Larami~ Heal~ Over~ How is ~ Poor    
    ##  7  2002 WY           WY - Larami~ Heal~ Over~ How is ~ Excelle~
    ##  8  2002 WY           WY - Larami~ Heal~ Over~ How is ~ Very go~
    ##  9  2002 WY           WY - Larami~ Heal~ Over~ How is ~ Good    
    ## 10  2002 WY           WY - Larami~ Heal~ Over~ How is ~ Fair    
    ## # ... with 16 more variables: sample_size <int>, data_value <dbl>,
    ## #   confidence_limit_low <dbl>, confidence_limit_high <dbl>,
    ## #   display_order <int>, data_value_unit <chr>, data_value_type <chr>,
    ## #   data_value_footnote_symbol <chr>, data_value_footnote <chr>,
